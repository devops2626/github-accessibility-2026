# GitHub Accessibility 2026

**Breaking Barriers: The Open-Source Blueprint for Inclusive Development**

A living multi-chapter book and community project.

## Table of Contents
- [Chapter 1: Introduction](./chapters/01-introduction.md)
- [Chapter 2: The Current Barriers](./chapters/02-barriers.md)
- [Chapter 3: The 4-Pillar Blueprint](./chapters/03-blueprint.md)
...
Use:
```bash
pandoc --from markdown+yaml_metadata_block metadata.yaml README.md chapters/*.md -o GitHub-Accessibility-2026.pdf --pdf-engine=xelatex --template=pandoc-template.tex
```
